...
report 52193442 "Appraisal List Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Appraisal List Report.rdlc';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Appraisal Scores Report';
    dataset
    {
        dataitem("HR Appraisal Header"; "HR Appraisal Header")
        {
            RequestFilterFields = "Appraisal No", "Appraisal Period", "Employee Name", Supervisor, "Appraisal Score";
    ...
    begin
        ...
        CompanyWebsite := compinfo."NLC Website";
        CompanyPhone := compinfo."Phone No.";
        CompyName := compinfo.Name;
    end;
