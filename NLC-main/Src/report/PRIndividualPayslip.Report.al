...
report 52193469 "PR Individual Payslip"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PR Individual Payslip.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("HR Employees"; "HR Employees")
        {
            ...
            dataitem("PR Salary Card"; "PR Salary Card")
            {
                ...
                column(PR_Salary_Card_Employee_Code; "PR Salary Card"."Employee Code") { }
                ...
                begin
                    ...
                    HREmployeePR.Reset();
                    HREmployeePR.SetRange(HREmployeePR."No.", "PR Salary Card"."Employee Code");
                    if HREmployeePR.Find('-') then begin

                        strEmpName := '[' + "PR Salary Card"."Employee Code" + '] ' + HREmployeePR."Last Name" + ' ' + HREmployeePR."First Name" + ' ' + HREmployeePR."Middle Name";
                        strPin := HREmployeePR."PIN No.";
                        dtDOE := HREmployeePR."Date Of Join";
                        "PR Salary Card".Status := Format(HREmployeePR.Status);
                    ...
                    *****************************************************************************************************/
                    ...
                    if PREmployerContr.Find('-') then
                        repeat
                            ...
                            if PREmployerContr."Transaction Code" = 'D68' then begin
                                Index += 1;
                                Trans[ColumnNo, Index] := 'Staff Pension Scheme: ';
                                Evaluate(TransAmt[ColumnNo, Index], Format(PREmployerContr.Amount));
                            end;
            ...
            begin
                ...
                DimensionValue.SetRange(DimensionValue.Code, "HR Employees"."Global Dimension 1 Code");
