...
report 52193495 "PR Individual Payslip Tests"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PR Individual Payslip Tests.rdlc';
    ApplicationArea = All;
    Caption = 'PR Individual Payslip Tests';
    dataset
    {
        dataitem("HR Employees"; "HR Employees")
        {
            ...
            dataitem("PR Salary Card"; "PR Salary Card")
            {
                ...
                dataitem("HR Employee Bank Accounts"; "HR Employee Bank Accounts")
                {
                    ...
                    begin
                        ...
                        if "HR Employee Bank Accounts".Find('-') then begin
            ...
            begin
                ...
                //HREmpBA.SETFILTER(HREmpBA."From payroll Period",FORMAT(SelectedPeriod));
