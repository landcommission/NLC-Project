...
report 52193704 "Sales Rep Transfer Order mod"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales Rep Transfer Order mod.rdlc';
    Caption = 'Sales Transfer Order';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Transfer Header"; "Transfer Header")
        {
            ...
            begin
                ...
                if "Transfer Header"."Quantity Shipped" = "Transfer Header"."Quantity Shipped"::"2" then
                    TransferHeaderTitle := 'Sales Rep Transfer Voucher'
                else
                    TransferHeaderTitle := 'Finished Goods Transfer Voucher';
            end;
        }
    }
