...
report 52193582 "prDeductions Report22"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/prDeductions Report22.rdlc';
    ApplicationArea = All;
    Caption = 'prDeductions Report22';
    dataset
    {
        dataitem("PR Period Transactions"; "PR Period Transactions")
        {
            DataItemTableView = sorting("Group Order", "Transaction Code", "Period Month", "Period Year") where("Group Text" = const('DEDUCTIONS'));
            ...
            column(IDNumber; objEmp."ID Number") { }
