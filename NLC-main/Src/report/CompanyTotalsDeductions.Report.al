...
report 52193479 "Company Totals Deductions"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Company Totals Deductions.rdlc';
    ...
    dataset
    {
        dataitem(prTransactionCodes; "PR Transaction Codes")
        {
            ...
            begin
                ...
                TOTDED := TOTDED + PAYEAmount + NSSFAmount + NHIFAmount + HSELEVY + HSELEVYARREAR;
