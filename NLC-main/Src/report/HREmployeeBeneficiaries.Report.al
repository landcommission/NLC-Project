...
report 50000 "HR Employee Beneficiaries"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("HR Employees"; "HR Employees")
        {
            ...
            dataitem("HR Employee Kin"; "HR Employee Kin")
            {
                ...
                DataItemTableView = sorting("Employee Code", Type, Relationship, "Full Name") where("Full Name" = filter(<> ''), Type = const(Beneficiary));
                ...
                column(PercentageShares_HREmployeeKin; "HR Employee Kin"."Percentage Shares") { }
            }
