report 52193551 priTax
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/priTax12.rdlc';
    ApplicationArea = All;
    Caption = 'priTax';
    dataset
    {
        dataitem("PR Period Transactions"; "PR Period Transactions")
        {
            ...
            begin
                ...
                SetFilter("PR Period Transactions"."Payroll Period", '=%1', SelectedPeriod);
            end;
        }
    }
    ...
    begin
        ...
        //ExcelBuf.OpenExcel();
        //ExcelBuf.CreateBookAndOpenExcel('iTax.xlsx', 'Sheet1', 'iTax', CompanyName, USERID);
