...
report 50012 "PR Payroll Variance NLC"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PR Payroll Variance NLC.rdlc';
    ApplicationArea = All;
    Caption = 'PR Payroll Variance NLC';
    dataset
    {
        dataitem("PR Transaction Codes"; "PR Transaction Codes")
        {
            ...
            begin
                ...
                "PR Transaction Codes".SetFilter("PR Transaction Codes"."Transaction Code", '<>%1', 'E31');
            end;
        }
    }
    ...
    begin
        ...
        if DepartmentCode <> '' then
            txt_DirectorateFilter := 'Directorate Code: ' + DepartmentCode;
