...
report 52193641 prPayrollSummary6
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/prPayrollSummary6.rdlc';
    ApplicationArea = All;
    Caption = 'prPayrollSummary6';
    dataset
    {
        dataitem("Dimension Value"; "Dimension Value")
        {
            ...
            dataitem("FA Budget Entry"; "FA Budget Entry")
            {
                ...
                //RequestFilterFields = Field35,Field324,Field188,Field36;
