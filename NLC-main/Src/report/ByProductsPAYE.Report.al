...
report 52193736 "By Products PAYE"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/By Products PAYE.rdlc';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Group Order", "Transaction Code", "Period Month", "Period Year") where("Transaction Code" = const('PAYE'));
