...
report 52193452 "HR Applicant CV 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/HR Applicant CV 2.rdlc';
    ApplicationArea = All;
    Caption = 'HR Applicant CV 2';
    dataset
    {
        dataitem("HR Job Applications"; "HR Job Applications")
        {
            ...
            dataitem("NAV Applicant Relevant Docs"; "NAV Applicant Relevant Docs")
            {
                ...
                column(HelbCertificate_NAVApplicantRelevantDocs; "NAV Applicant Relevant Docs"."Helb Certificate") { }
                column(GoodConductCertificate_NAVApplicantRelevantDocs; "NAV Applicant Relevant Docs"."Good Conduct Certificate") { }
                column(CRBCertificate_NAVApplicantRelevantDocs; "NAV Applicant Relevant Docs"."CRB Certificate") { }
                column(EACCCertificate_NAVApplicantRelevantDocs; "NAV Applicant Relevant Docs"."EACC Certificate") { }
                column(KRAPinCertificate_NAVApplicantRelevantDocs; "NAV Applicant Relevant Docs"."KRA Pin Certificate") { }
                column(Tempbool; Tempbool) { }

                trigger OnAfterGetRecord()
                begin
                    Tempbool := false;
                    if ("NAV Applicant Relevant Docs"."Helb Certificate") or not ("NAV Applicant Relevant Docs"."Helb Certificate") then
                        Tempbool := true;
                end;
            }
