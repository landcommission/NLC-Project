...
report 52193537 "prPaySlip2 Casual"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/prPaySlip2 Casual.rdlc';
    ApplicationArea = All;
    Caption = 'prPaySlip2 Casual';
    dataset
    {
        dataitem("HR Employees"; "HR Employees")
        {
            DataItemTableView = sorting("No.");
            RequestFilterFields = "Current Month Filter", Status, "Location/Division Code", County, "Cost Center Code", "Salary Grade", "Salary Notch/Step", "No.";
            column(ReportForNavId_8631; 8631) { }
            column(CompanyInfo_Name; CompanyInfo.Name) { }
            column(CompanyInfo_Picture; CompanyInfo.Picture) { }
            column(HR_Employee_No_; "HR Employees"."No.") { }
            column(strAccountNo; strAccountNo) { }
            dataitem("prSalary Card Casual"; "prSalary Card Casual")
            {
                ...
                column(prSalary_Card_Employee_Code; "prSalary Card Casual"."Employee Code") { }
                ...
                begin
                    ...
                    objEmp.Reset();
                    objEmp.SetRange(objEmp."No.", "prSalary Card Casual"."Employee Code");
                    if objEmp.Find('-') then begin
                        ...
                        strEmplCode := "prSalary Card Casual"."Employee Code";
                        ...
                        DimensionValue.SetRange(DimensionValue.Code, "HR Employees".County);
                        ...
                        PeriodTrans.Reset();
                        PeriodTrans.SetRange(PeriodTrans."Employee Code", "prSalary Card Casual"."Employee Code");
                    ...
                    *****************************************************************************************************/
                    if ("prSalary Card Casual"."Suspend Pay" = false) then
                        strEmpCode := "prSalary Card Casual"."Employee Code";
                    /******************************************************************************************************/
                ...
                begin
                    NoOfRecords := "prSalary Card Casual".Count;
                    NoOfColumns := 2;
    ...
    var
        ...
        P_I_N_No_CaptionLbl: Label 'RSA PIN:';
