...
report 52193430 "HR Applicant CV"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/HR Applicant CV.rdlc';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'HR Applicant CV';
    dataset
    {
        dataitem("HR Job Applications"; "HR Job Applications")
        {
            ...
            column(CompnyName; CompInfo.Name)
            { }
            column(CompnyAdress; CompInfo.Address)
            {

            }
            column(CompanyPhon; CompInfo."Phone No.")
            {

            }
            column(COmpanyWebsite; CompInfo."NLC Website")
            {
            ...
            dataitem("HR Appl Employment History"; "HR Appl Employment History")
            {
                ...
                column(PhoneNo_HRApplEmploymentHistory; "HR Appl Employment History".PhoneNo) { }
                column(EmployedDate; "HR Appl Employment History"."Date Employed") { }
            }
            ...
            dataitem("HR Current Employment"; "HR Current Employment")
            {
                ...
                column(JobID_HRCurrentEmployment; "HR Current Employment".JobID) { }
                ...
                dataitem("Applicant Referees"; "Applicant Referees")
                {
                    ...
                    column(ID_ApplicantReferees; "Applicant Referees".ID) { }
                    column(ApplicantNo_ApplicantReferees; "Applicant Referees".ApplicantNo) { }
                    column(FullName_ApplicantReferees; "Applicant Referees".FullName) { }
                    column(Address_ApplicantReferees; "Applicant Referees".Address) { }
                    column(Email_ApplicantReferees; "Applicant Referees".Email) { }
                    column(MobileNo_ApplicantReferees; "Applicant Referees".MobileNo) { }
                    column(Occupation_ApplicantReferees; "Applicant Referees".Occupation) { }
                    column(ReferenceType_ApplicantReferees; "Applicant Referees".ReferenceType) { }
                    column(Company_ApplicantReferees; "Applicant Referees".Company) { }
                }
            }
        }
    }
