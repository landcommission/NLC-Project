...
report 52193631 "PR Employee Salary Increments1"
{
    ProcessingOnly = true;
    ApplicationArea = All;
    Caption = 'PR Employee Salary Increments1';
    dataset
    {
    ...
    var
        ...
        PRSalaryScale: Record "PR Employees Salary Scale1";
        PRSalaryScale2: Record "PR Employees Salary Scale1";
