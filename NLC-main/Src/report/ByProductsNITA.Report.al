...
report 52193740 "By Products NITA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/By Products NITA.rdlc';
    ApplicationArea = All;
    Caption = 'By Products NITA';
    dataset
    {
        dataitem("PR Period Transactions"; "PR Period Transactions")
        {
            DataItemTableView = sorting("Group Order", "Transaction Code", "Period Month", "Period Year") where("Transaction Code" = const('NITA'));
