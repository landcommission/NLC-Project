...
report 52193550 "PR Trans  Variance Analysis"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PR Trans  Variance Analysis.rdlc';
    ...
    dataset
    {
        dataitem("PR Transaction Codes"; "PR Transaction Codes")
        {
            ...
            begin
                ...
                //Period 2
                PeriodTr.Reset();
                PeriodTr.SetRange(PeriodTr."Transaction Code", "PR Transaction Codes"."Transaction Code");
                PeriodTr.SetRange(PeriodTr."Payroll Period", Period2_Filter);
                if PeriodTr.Find('-') then begin
                    PeriodTr.CalcSums(PeriodTr.Amount);
                    Period_2_TransAmount := PeriodTr.Amount;
                end;
    ...
    var
        ...
        Period1_Filter: Date;
        Period2_Filter: Date;
        PeriodTr: Record "PR Period Transactions";
        AppliedFilters: Text;
