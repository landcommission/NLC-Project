...
report 50004 "HR Employee Office Equipment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/HR Employee Office Equipment.rdlc';
    ...
    dataset
    {
        dataitem("HR Employees"; "HR Employees")
        {
            ...
            dataitem("Employee Equipment"; "Employee Equipment")
            {
                DataItemLink = "Employee code" = field("No.");
                DataItemTableView = sorting("Employee code", "Office Equipment/Machine");
                column(ReportForNavId_5; 5) { }
                column(OfficeEquipmentMachine_EmployeeEquipment; "Employee Equipment"."Office Equipment/Machine") { }
            }
