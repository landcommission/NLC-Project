...
report 50015 "Salary Advance"
{
    ...
    dataset
    {
        dataitem("PR Period Transactions"; "PR Period Transactions")
        {
            ...
            DataItemTableView = sorting("Group Order", "Transaction Code", "Period Month", "Period Year") where("Transaction Code" = const('D57'));
