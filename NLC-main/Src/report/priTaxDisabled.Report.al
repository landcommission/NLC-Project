...
report 52193552 "priTax-Disabled"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/priTax-Disabled.rdlc';
    ...
    begin
        ...
        ExcelBuf.AddColumn('Exemption Certificate Number', false, '', false, false, false, '', 0);
        ...
        ExcelBuf.AddColumn('Exemption for Persons with Disability', false, '', false, false, false, '', 0);
    ...
    begin
        ...
        objEmp.SetRange(objEmp.Disabled, objEmp.Disabled::Yes);
        if objEmp.Find('-') then begin
            ...
            ExcelBuf.AddColumn(objEmp."Exemption Certificate No.", false, '', false, false, false, '', 0);
            ...
            ExcelBuf.AddColumn('', false, '', false, false, false, '', 0); //exemption
    ...
    begin
        ExcelBuf.CreateNewBook('iTax');
        ExcelBuf.WriteSheet('iTax', CompanyName, UserId);
        ExcelBuf.CloseBook();
        ExcelBuf.SetFriendlyFilename(StrSubstNo('iTax_%1_%2', CurrentDateTime, UserId));
