...
codeunit 52193430 "HR Appraisal Jnl.-Post Batch"
{
    ...
    var
        ...
        InsuranceJnlBatch: Record "HR Appraisal Journal Batch";
        InsuranceReg: Record "HR BSC Register";
        InsCoverageLedgEntry: Record "HR Appraisal Ledger Entries";
        InsuranceJnlLine2: Record "HR Appraisal Journal Line";
        InsuranceJnlLine3: Record "HR Appraisal Journal Line";
        NoSeries: Record "No. Series" temporary;
        FAJnlSetup: Record "HR Setup";
        InsuranceJnlPostLine: Codeunit "HR Appraisal Jnl.-Post Line";
    ...
    begin
        begin
            ...
            repeat
                ...
                JnlLineDim.SetRange("Table ID", Database::"HR Leave Journal Line");
            ...
            repeat
                ...
                if not (InsuranceJnlLine."Appraisal Period" = '') and
                ...
                if InsuranceJnlLine."Posting No. Series" = '' then
                    ...
                    if not (InsuranceJnlLine."Appraisal Period" = '') then
            ...
            if InsuranceRegNo <> 0 then begin
                ...
                InsuranceJnlLine2.SetFilter("Appraisal Period", '<>%1', '');
