...
page 52193748 "Item/Cash Requisition Card"
{
    ...
    SourceTableView = where("Payment Type" = filter("Cash Purchase"),
                            Posted = const(false));
    ApplicationArea = All;
    Caption = 'Item/Cash Requisition Card';
    layout
    {
        area(Content)
        {
    ...
    actions
    {
        area(Processing)
        {
            ...
            {
                Caption = '&Functions';
                action("Post Payment origi")
                {
                    ApplicationArea = Basic;
                    Caption = 'Post Payment origi';
                    ToolTip = 'Executes the Post Payment origi action.';
                    trigger OnAction()
                    begin
                        //Post PV Entries
                        //Check Petty Cash Limit Amount
                        CashOfficeSetup.Get();
                ...
                action("Print/Preview")
                {
                    ...
                    begin
                        ...
                        Report.Run(39004271, true, true, Rec);
                        Rec.Reset();
                    end;
                }
    ...
    begin
        ...
        Appl.Init();
        Appl."Line No." := LineNo;
        Appl."Document Type" := Appl."Document Type"::PC;
