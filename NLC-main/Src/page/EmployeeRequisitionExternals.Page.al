...
page 52193595 "Employee Requisition Externals"
{
    ...
    ApplicationArea = All;
    Caption = 'Employee Requisition Externals';
    layout
    {
        area(Content)
        {
    ...
    begin
        ...
        Rec.SetFilter(Rec."Requisition Type", '%1|%2', Rec."Requisition Type"::External, Rec."Requisition Type"::Both);
