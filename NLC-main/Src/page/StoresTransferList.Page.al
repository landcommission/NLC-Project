...
page 52193694 "Stores Transfer List"
{
    Caption = 'Stores Transfer List';
    CardPageId = "Stores Transfer Order";
    Editable = false;
    PageType = List;
        ...
        area(Processing)
        {
            action("&Print")
            {
                ...
                begin
                    ...
                    Report.Run(39005994, false, true, Rec);
                end;
            }
            group(Release)
            {
    ...
    begin
        Rec."Quantity Shipped" := Rec."Quantity Shipped"::"3"
    end;
