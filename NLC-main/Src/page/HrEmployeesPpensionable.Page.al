...
page 50043 "HR Employees(P'/Pensionable)"
{
    CardPageId = "HR Employee Card";
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Employee';
    SourceTable = "HR Employees";
    SourceTableView = where("Contract Type" = const("Permanent and Pensionable"));
    ApplicationArea = All;
    Caption = 'Hr Employees Permanent and Pensionable';
    layout
    {
        area(Content)
        {
