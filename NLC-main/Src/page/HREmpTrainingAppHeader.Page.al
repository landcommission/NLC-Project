...
page 52194148 "HR Emp Training App. Header"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    ApplicationArea = All;
    Caption = 'HR Emp Training App. Header';
    layout
    {
        area(Content)
        {
        ...
        area(Navigation)
        {
            ...
            group("F&unctions")
            {
                ...
                action("&Approvals")
                {
                    ...
                    trigger OnAction()
                    var
                        DocumentType: Option Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order",None,PV,"Petty Cash",Imp,Reqn,ImpSurr,Interbank,Receipt,"Staff Claim","Staff Adv",AdvanceSurr,"Bank Slip",Grant,"Grant Surr","Employee Requisition","Leave Application","Training Requisition","Transport Requisition",JV,"Grant Task","Concept Note",Proposal,"Job Approval","Disciplinary Approvals",GRN,Clearence,Donation,Transfer,PayChange,Budget,GL,"Cash Purchase","Leave Reimburse",Appraisal,Inspection,Closeout,"Lab Request",ProposalProjectsAreas,"Leave Carry over","IB Transfer",EmpTrans,LeavePlanner,HrAssetTrans,Contract,Project,MR,Inves,PB,Prom,Ind,Conf,BSC,OT,Jobsucc,SuccDet,Qual,Disc,Clear,"Short Train","Long Train";
                        ApprovalEntries: Page "Approval Entries";
                    begin

                        if Rec."Training Type" = Rec."Training Type"::"Long Term Training" then
                            DocumentType := DocumentType::"Long Train";
                        if Rec."Training Type" = Rec."Training Type"::"Short Term Training" then
                            DocumentType := DocumentType::"Short Train";
                ...
                action("&Print")
                {
                    ...
                    begin
                        ...
                        if HRTrainingApplications.Find('-') then
                            Report.Run(Report::"Staff Training Request Form", true, true, HRTrainingApplications);
                    end;
                }
    ...
    begin
        Rec.TestField(Rec."Training Type");
    end;
