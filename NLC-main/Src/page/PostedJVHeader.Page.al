        ...
        area(Processing)
        {
            group("F&unctions")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ApprovalEntries.Setfilters(Database::"JV Header", 13, Rec."Document No.");
                        ApprovalEntries.Run();
                    end;
                }
                action("Send A&pproval Request")
                {
                    ...
                    begin
                        ...
                        //ApprovalMgt.SendJVDocApprovalRequest(Rec) then;
                    end;
                }
                action("Cancel Approval Re&quest")
                {
                    ...
                    begin
                        ...
                        //ApprovalMgt.CancelJVDocApprovalRequest(Rec, true, true) then;
                    end;
                }
                action("Test Report")
                {
