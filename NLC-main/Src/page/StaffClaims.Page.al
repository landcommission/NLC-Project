...
page 52193661 "Staff Claims"
{
        ...
        area(Processing)
        {
            group("&Functions")
            {
                ...
                action("ReOpen Document")
                {
                    ...
                    trigger OnAction()
                    begin
                        if not Confirm('Are you sure you want to ReOpen the Document?', false) then
                            exit;
    ...
    begin
        DocNoVisible := DocumentNoVisibility.FundsMgtDocumentNoIsVisible(DocType::"Staff Claim", Rec."No.");
    end;
}
