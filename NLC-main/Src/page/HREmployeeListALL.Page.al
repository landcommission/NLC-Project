...
page 52193445 "HR Employee List (ALL)"
{
    ApplicationArea = Basic;
    Caption = 'HR Employee List (ALL) - Active';
    CardPageId = "HR Employee Card";
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Employee, Employee Details,Set Inactive';
