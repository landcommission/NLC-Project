...
page 52193713 "Posted Imprest Acct. List"
{
    ...
    ApplicationArea = All;
    Caption = 'Posted Imprest Acct. List';
    layout
    {
        area(Content)
        {
            ...
            group("<Action1102756004>")
            {
                ...
                action("<Action1102756007>")
                {
                    ...
                    begin
                        ...
                        //ApprovalMgt.SendImprestSURRApprovalRequest(Rec) then;
                    end;
                }
                action("<Action1102756008>")
                {
                    ...
                    begin
                        ...
                        //ApprovalMgt.CancelImprestSUApprovalRequest(Rec, true, true) then;
                    end;
                }
