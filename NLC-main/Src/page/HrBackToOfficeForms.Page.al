...
page 52193614 "Hr Back To Office Forms"
{
    PageType = Card;
    SourceTable = "HRBack To Office Forms";
    ApplicationArea = All;
    Caption = 'Hr Back To Office Forms';
    layout
    {
        area(Content)
        {
            ...
            group("F&unctions")
            {
                ...
                action("&Approvals")
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.Setfilters(Database::"HRBack To Office Forms", DocumentType, Rec."Document No");
                        ApprovalEntries.Run();
                    end;
                }
