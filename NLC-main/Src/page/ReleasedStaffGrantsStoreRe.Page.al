...
page 52193740 "Released Staff Grants Store Re"
{
    Caption = 'Released Staff Grants Store Requisitions List';
    CardPageId = "PR Employee Allowances List";
    PageType = List;
    PromotedActionCategories = 'New,Process,Reports,Approvals,Cancellation,Category6_caption,Category7_caption,Category8_caption,Category9_caption,Category10_caption';
    SourceTable = "Store Requistion Header";
    SourceTableView = where(Status = const(Released),
                            "Document Type" = const(SR));
    ApplicationArea = All;
            ...
            group("<Action1102755026>")
            {
                ...
                action("<Action1102755028>")
                {
                    ...
                    begin
                        ...
                        if UserSetup."Post Staff Grants" <> true then
                            Error('You do not have rights to post the staff grants, please consult administrator to set this up');
                ...
                action("Print/Preview")
                {
                    ...
                    begin
                        ...
                        Rec.Reset();
                        Rec.SetRange(Rec."Document Type", Rec."Document Type"::SR);
                    end;
                }
            }
        }
