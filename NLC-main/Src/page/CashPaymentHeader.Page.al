...
page 52193637 "Cash Payment Header"
{
                ...
                action("Print/Preview")
                {
                    ...
                    begin
                        ...
                        if Rec."Creation Doc No." = '' then
                            Report.Run(Report::"Petty Cash Voucher NCA", true, true, Rec)
                        else
                            Report.Run(Report::"Petty Cash Voucher NCA", true, true, Rec);
                        Rec.Reset();
                    end;
    ...
    begin
        DocNoVisible := DocumentNoVisibility.FundsMgtDocumentNoIsVisible(DocType::"Petty Cash", Rec."No.");
    end;
