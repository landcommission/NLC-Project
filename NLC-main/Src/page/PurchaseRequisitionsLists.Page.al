        ...
        area(Processing)
        {
            group("<Action1102755026>")
            {
                ...
                action("<Action1102755036>")
                {
                    ...
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Purchase Requsition action.';
                    trigger OnAction()
                    begin
                        Rec.Reset();
