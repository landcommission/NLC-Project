...
page 52193575 "Salary Advance Card"
{
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Start Payroll Deduction Month"; Rec."Start Payroll Deduction Month")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Start Payroll Deduction Month field.';
                }
            ...
            group("&Functions")
            {
                ...
                action("Update Payroll")
                {
                    ...
                    begin
                        ...
                        Rec.TestField("Start Payroll Deduction Month");
                        Rec.TestField("No.of Months to Repay");
                        ...
                        if Confirm('Are you sure you want to Update the Payroll with this Deduction for Salary advance for Employee %1?', true, Rec."Employee No") = false then
                            exit;
                        //Commented to prevent auto insert for Salary Adavance to Payroll::
                        RequestLines.CalcFields(RequestLines."Payroll Deduct Month");
                        RequestLines.Reset();
                        ...
                        if RequestLines.Find('-') then begin
                            repeat
                                ...
                                PREmployeeTransactions.SetRange(PREmployeeTransactions."Payroll Period", Rec."Start Payroll Deduction Month");
                                if PREmployeeTransactions.Find('-') then
                                    Rec.CalcFields("Total Net Amount");
                                PREmployeeTransactions.Reset();
                                PREmployeeTransactions."Transaction Code" := 'D57';
                                PREmployeeTransactions."Payroll Period" := Rec."Start Payroll Deduction Month";
                                PREmployeeTransactions.Amount := Rec."Monthly Repayment Amount";
                                PREmployeeTransactions."Transaction Name" := 'Salary Advance Payment';
                                PREmployeeTransactions."Original Amount" := Rec."Total Net Amount";
                                PREmployeeTransactions."#of Repayments" := 12;
                                PREmployeeTransactions.Insert();
                            until RequestLines.Next() = 0;
                            Rec."Payroll Updated" := true;
                            Rec.Modify();
                            Message('Payroll for %1 Updated Sucessfully', Rec."Employee No");
                        end;
                    end;
                }
                action(PrintPreview)
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.Setfilters(Database::"Staff Advance Headers", DocumentType, Rec."No.");
                        ApprovalEntries.Run();
                    end;
                }
            }
    ...
    var
        ...
        RequestLines: Record "Staff Advance Line";
