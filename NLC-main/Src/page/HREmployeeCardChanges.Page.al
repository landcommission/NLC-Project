...
page 52194207 "HR Employee Card - Changes"
{
    PageType = Card;
    PromotedActionCategories = 'New,Process,Report,Print,Functions,Employee,Attachments,Workflow Process';
    SourceTable = "HR Employees - Changes";
    ApplicationArea = All;
    Caption = 'HR Employee Card - Changes';
    layout
    {
        area(Content)
        {
            ...
            group(Functions)
            {
                    ...
                    begin
                        ...
                        */
                        ...
                        if Rec."Approval Status" <> Rec."Approval Status"::Open then
                            exit;
                        if Confirm('Are you suree you want to Send Approval Request?', true) = false then
                            exit;
                        VarVariant := Rec;
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        // ApprovalEntries.SetRecordFilters(Database::"HR Employees - Changes", DocumentType, Rec.Code);
                        // ApprovalEntries.Run();
