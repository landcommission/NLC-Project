...
page 52193805 "Purchase Requisition Card"
{
    DeleteAllowed = true;
    Editable = true;
    InsertAllowed = true;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(Control1102755015; "Salary Advance Request Crd")
            {
                Editable = true;
        ...
        area(Processing)
        {
            group("&Functions")
            {
                ...
                action(Approvals)
                {
                    ...
                    trigger OnAction()
                    begin
                        DocumentType := DocumentType::PReq;
                ...
                action("Send A&pproval Request")
                {
                    ...
                    begin
                        ...
                        //ApprovalMgt.SendAdvanceApprovalRequest(Rec)
                    end;
                }
