...
page 52193667 "Staff Advance Surrender List"
{
    Caption = 'Staff Imprest Surrender List';
    ...
    begin
        ...
        if UserMgt.GetSetDimensions(UserId, 2) <> '' then begin
            Rec.FilterGroup(2);
            Rec.SetRange(Rec."Global Dimension 2 Code", UserMgt.GetSetDimensions(UserId, 2));
            Rec.FilterGroup(0);
        end;
    end;
    ...
    begin
        ...
        SClaimHdr."Account Type" := Rec."Account Type"::Customer;
