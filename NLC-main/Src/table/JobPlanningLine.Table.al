...
table 52193743 "Job-Planning Line"
{
    Caption = 'Job Planning Line';
    DrillDownPageId = "Grant Planning List";
    LookupPageId = "Grant Planning List";
    PasteIsValid = false;
    DataClassification = CustomerContent;
    //Permissions = TableData UnknownTableData39004351=rimd;
    ...
    fields
    {
        ...
        field(7; "No."; Code[20])
        {
            ...
            if (Type = const("G/L Account")) "G/L Account" where("Donor defined Account" = filter(true))
            else
        ...
        {
            CalcFormula = sum("Grant Surrender Details"."Actual Spent" where("Job-Planning Line No" = field("Line No."),
        ...
        field(50023; "Total Year 6"; Decimal)
        {
            CalcFormula = sum("Job-Planning Line"."Total Cost (LCY)" where("Budget Period" = const('YEAR 6'),
                                                                            ...
                                                                            "Grant No." = field("Grant No.")));
            FieldClass = FlowField;
            Caption = 'Total Year 6';
            Editable = false;
        }
        field(50024; "Budget in use"; Boolean)
        {
            Caption = 'Budget in use';
        }
    }
    ...
    var
        ...
        DEC: Record "Donor IC G/L Account";
    ...
    begin
        if ("Unit Cost" <> xRec."Unit Cost") or ("Cost Factor" <> xRec."Cost Factor") then
    ...
    procedure UpdatePostedTotalCost(var JobLedgerEntry: Record "Job-Ledger Entry")
    begin
