...
table 52193670 "Staff Advance Surrender Header"
{
    ...
    fields
    {
        ...
        field(46; "Imprest Issue Doc. No"; Code[20])
        {
            ...
            begin
                ...
                if Page.RunModal(39005581, AdvHeader) = Action::LookupOK then
            ...
            begin
                ...
                PayHeader.Reset();
                if not PayHeader.Get(Rec."Imprest Issue Doc. No") then
                    exit;
        ...
        field(102; "Amount on Original Document"; Decimal)
        {
            ...
            Caption = 'Amount on Original Document';
        }
    ...
    begin
        ...
        if UserSetup.Get(UserId) then begin
            UserSetup.TestField("Other Advance Staff Account");//"Staff Travel Account");
