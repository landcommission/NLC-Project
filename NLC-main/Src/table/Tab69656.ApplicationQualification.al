...
Table 69656 "Application Qualification"
{
    ...
    fields
    {
        ...
        field(3; "Qualification Code"; Code[50])
        {
            ...
            trigger OnValidate()
            var
                Qualtyp: Record "HR Job Qualifications";
            begin
                Qualtyp.Reset();
                Qualtyp.SetRange(Qualtyp.code, rec."Qualification Code");
                if Qualtyp.FindFirst() then
                    Description := Qualtyp.Description;
            end;
        ...
        // field(17; "Qualification Category"; Text[50])
        // {
        //     DataClassification = ToBeClassified;
        ...
        field(37; "Qualification Type"; Code[60])
        {
            NotBlank = false;
            TableRelation = "HR Lookup Values".Code where(Type = filter("Qualification Type"), Level = const('ACADEMIC'));
