...
table 52193560 "Transfer Schedule 1"
{
    Caption = 'Salutation';
    ...
    fields
    {
        ...
        field(3; "Employee Code"; Code[20])
        {
            ...
            begin
                if CompanyStaff.Get("Employee Code") then begin
                    ...
                    rec.Validate("Current Department");
        ...
        field(67; "Responsibility Center"; Code[30])
        {
            TableRelation = "Responsibility Center BR NEW".Code;
            Caption = 'Responsibility Center';
        }
        field(68; "Department Name"; Text[200])
        {
    ...
    begin
        ...
        if Code = '' then begin
            HRSetup.Get();
            HRSetup.TestField(HRSetup."Transfer Nos");
            NoSeriesMgt.InitSeries(HRSetup."Transfer Nos", xRec."No. Series", 0D, Code, "No. Series");
        end;
