...
table 52193607 "HR Employee Info Change"
{
    Caption = 'HR Employee Info Change';
    DataCaptionFields = "No.", "Full Name", "Job Title";
    DrillDownPageId = "HR Employee Information Change";
    LookupPageId = "HR Employee Information Change";
    ...
    fields
    {
        ...
        {
            TableRelation = "Responsibility Center BR NEW".Code;
            Caption = 'Responsibility Centre2';
        }
