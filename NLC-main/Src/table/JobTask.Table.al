...
table 52193741 "Job-Task"
{
    ...
    fields
    {
        ...
        field(10; "Schedule (Total Cost)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("Job-Planning Line"."Total Cost (LCY)" where("Grant No." = field("Grant No."),
                                                                            "Grant Task No." = field("Grant Task No."),
                                                                            "Grant Task No." = field(filter(Totaling)),
        ...
        field(11; "Schedule (Total Price)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("Job-Planning Line"."Line Amount (LCY)" where("Grant No." = field("Grant No."),
                                                                             "Grant Task No." = field("Grant Task No."),
                                                                             "Grant Task No." = field(filter(Totaling)),
                                                                             "Schedule Line" = const(true),
                                                                             "Planning Date" = field("Planning Date Filter")));
        ...
        field(12; "Usage (Total Cost)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("Job-Ledger Entry"."Total Cost (LCY)" where("Job No." = field("Grant No."),
        ...
        field(13; "Usage (Total Price)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("Job-Ledger Entry"."Line Amount (LCY)" where("Job No." = field("Grant No."),
                                                                            "Job Task No." = field("Grant Task No."),
                                                                            "Job Task No." = field(filter(Totaling)),
                                                                            "Entry Type" = const(Usage),
                                                                            "Posting Date" = field("Posting Date Filter")));
