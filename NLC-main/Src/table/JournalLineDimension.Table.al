...
table 52193771 "Journal Line Dimension"
{
    ...
    fields
    {
        ...
        field(2; "Journal Template Name"; Code[10])
        {
            ...
            if ("Table ID" = const(39004334)) "Job-Journal Line"."Journal Template Name"
            else
        ...
        field(3; "Journal Batch Name"; Code[10])
        {
            ...
            if ("Table ID" = const(39004334)) "Job-Journal Batch".Name where("Journal Template Name" = field("Journal Template Name"))
            else
