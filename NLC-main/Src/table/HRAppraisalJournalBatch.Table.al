...
table 52193856 "HR Appraisal Journal Batch"
{
    DataCaptionFields = Name, Description;
    DrillDownPageId = "HR Appraisal Batches";
    LookupPageId = "HR Appraisal Batches";
    Caption = 'HR Appraisal Journal Batch';
    ...
    fields
    {
        field(1; "Journal Template Name"; Code[20])
        {
            ...
            NotBlank = true;
            TableRelation = "HR Appraisal Journal Template".Name;
        }
