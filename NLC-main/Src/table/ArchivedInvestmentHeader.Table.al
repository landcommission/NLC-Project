...
table 52193709 "Archived Investment Header"
{
    DrillDownPageId = "Archived Investment List";
    LookupPageId = "Archived Investment List";
    Caption = 'Archived Investment Header';
