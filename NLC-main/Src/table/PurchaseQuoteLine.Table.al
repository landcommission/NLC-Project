...
table 52193681 "Purchase Quote Line"
{
    Caption = 'Purchase Quote Line';
    //LookupPageID = UnknownPage39004371;
    PasteIsValid = false;
    ...
    fields
    {
        ...
        field(39004240; Committed; Boolean)
        {
            Caption = 'Committed';
        }
        field(39004241; "Expense Code"; Code[10])
        {
            TableRelation = "Expense Code".Code;
            Caption = 'Expense Code';
        }
        field(39004242; "Asset No."; Code[10])
        {
            TableRelation = "Fixed Asset"."No.";
            Caption = 'Asset No.';
        }
        field(39004243; Specifications; Integer)
        {
            Caption = 'Specifications';
        }
        field(39004244; "PRF No"; Code[20])
        {
            Caption = 'PRF No';
        }
        field(39004245; "PRF Line No."; Integer)
        {
            Caption = 'PRF Line No.';
        }
        field(39004246; "Qty Received"; Decimal)
        {
            CalcFormula = sum("Purch. Rcpt. Line".Quantity where(t = field("Document No."),
        ...
        field(39004353; "Extended Order Description"; Text[150])
        {
            Caption = 'Extended Order Description';
        }
