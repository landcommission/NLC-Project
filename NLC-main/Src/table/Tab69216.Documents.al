...
Table 69216 "Documents"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Company,Leave,Payment Voucher,HrJobs,Employee,Discplinary';
            OptionMembers = Company,Leave,"Payment Voucher",HrJobs,Employee,Discplinary;
        }
    }
