...
Table 69647 "Job Applicants Qualification"
{
    ...
    fields
    {
        ...
        field(3; "Qualification Category"; Text[50])
        {
            DataClassification = ToBeClassified;
        ...
        field(4; "Qualification Code"; Code[10])
        {
            ...
            //TableRelation = "HR Job Qualifications".Code where("Qualification Type" = field("Qualification Category"));

            TableRelation = "HR Lookup Values" where(Level = field("Qualification Category"));
        }
