...
table 52193857 "HR Appraisal Journal Template"
{
    DrillDownPageId = "HR Appraisal Jnl. Template";
    LookupPageId = "HR Appraisal Jnl. Template";
    Caption = 'HR Appraisal Journal Template';
